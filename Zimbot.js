...
module.exports = ZimBotInc = async (ZimBotInc, m, chatUpdate, store) => {
  try {
    ...
    const reply = (teks) => {
      ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo: { "externalAdReply": { title: "JUAN B", mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true, body: "BOT", thumbnail: fs.readFileSync('./drips.jpg'), sourceUrl: ("https://github.com/juanbhmx") } } })
    }
    const replay = (teks) => {
      ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo: { "externalAdReply": { title: "JUAN B", mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "BOT", thumbnail: fs.readFileSync('./drips.jpg'), sourceUrl: ("https://github.com/juanbhmx") } } })
    }
    ...
    const drip = {
      ...
      contextInfo: {
        ...
        body: "GIVE IT A STAR",
        mediaType: "VIDEO",
        mediaUrl: `https://github.com/juanbhmx`,
        description: '240699',
        previewType: "PHOTO",
    ...
    if (global.dripsreadall) {
      if (m.message) { ZimBotInc.sendReadReceipt(m.chat, m.sender, [m.key.id]) }
    }
    if (global.dripsrecord) {
      if (m.chat) { ZimBotInc.sendPresenceUpdate('recording', m.chat) }
    }

    if (global.dripstyping) {
      if (m.chat) { ZimBotInc.sendPresenceUpdate('composing', m.chat) }
    }
    if (global.available) {
      if (m.chat) { ZimBotInc.sendPresenceUpdate('available', m.chat) }
    }
    if (global.unavailable) {
      if (m.chat) { ZimBotInc.sendPresenceUpdate('unavailable', m.chat) }
    }
      ...
      try {
        ...
        emoji.get(satu)
          .then(emoji => {
            ...
            const buttonMessage = { image: { url: emoji.images[dua].url }, caption: "BAUTISTA", footerText: 'Loading...', buttons: buttons, headerType: 4 }
...
`
    ...
    setTimeout(function () {
      ZimBotInc.sendMessage(ZimBotInc.user.id, { text: `*RESPETA WEBON ANNOUNCEMENT:* *SUBSCRIBE TO 240699*\n\n*YOUTUBE:* https://github.com/juanbhmx\n\n*NEW FEATURES COMING SOON SO STAY TUNED*\n\n*FEEL FREE TO BRING IDEAS OF THE FEATURES ON THE TABLE*\n\n*IF YOU WANT TO CONTRUBUTE FORK THE REPO, MAKE CHANGES PUSH YOUR CHANGES TO THE ORIGIN BRANCH AND WAIT FOR YOUR PULL REQUEST TO BE VERIFIED*\n\n*Thanks for choosing zim-bot*`, contextInfo: { externalAdReply: { title: "BAUTISTA", body: "SUBSCRIBE 240699", showAdAttribution: true, mediaType: 2, thumbnail: fs.readFileSync(`./drips.jpg`), mediaUrl: `https://github.com/juanbhmx`, sourceUrl: `https://github.com/juanbhmx` } } }, { quoted: m })
        ...
        let buttonMessage = {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              mediaType: 1,
              mediaUrl: 'https://github.com/juanbhmx',
              sourceUrl: "https://github.com/juanbhmxg"
            }
          }
        }
        ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
      ...
      */
      ...
      case 'git': case 'gitclone':
        ...
        ZimBotInc.sendMessage(m.chat, {
          document: { url: url }, fileName: filename + '.zip', mimetype: 'application/zip', quoted: m, contextInfo: {
            externalAdReply: {
              title: "BAUTISTA",
              body: "SUB 240699",
              showAdAttribution: true,
              ...
              thumbnail: fs.readFileSync('./drips.jpg'),
              mediaUrl: `https://github.com/juanbhmx`,
              sourceUrl: `https://github.com/juanbhmx`,
            }
          }
        })
      ...
      case 'truth':
        ...
        ZimBotInc.sendMessage(m.chat, {
          image: truteh, caption: '*Truth*\n\n' + ttrth, quoted: m, contextInfo: {
            externalAdReply: {
              title: "BAUTISTA",
              body: "SUB 240699",
              showAdAttribution: true,
...
0.02━━━━━━━━━━━━━3.26
      🔂   ⏪   ⏸️     ⏩  🎵*\n\n*TITLE :* ${media.title}\n*FILESIZE :* ${media.filesizeF}\n*URL :* ${isUrl(text)}\n*EXT :* MP3\n*RESOLUTION :* ${args[1] || '128kbps'}\n\n*RESPETA WEBON*`
        ...
        ZimBotInc.sendMessage(m.chat, { image: { url: media.thumb }, jpegThumbnail: buf, caption: `${caption}` }, { quoted: m }).catch((err) => m.reply('*Sorry, the link you provided is not valid*'))
        ZimBotInc.sendMessage(m.chat, {
          audio: { url: media.dl_link }, mimetype: "audio/mpeg", fileName: `${media.title}.mp3`, quoted: m, contextInfo: {
            externalAdReply: {
              title: "BAUTISTA",
              body: "DRIPS",
              showAdAttribution: true,
...
0.02━━━━━━━━━━━━━3.26
      🔂   ⏪   ⏸️     ⏩  🎵\n\n*Title* : ${media.title}\n*FILESIZE* : ${media.filesizeF}\n*URL* : ${isUrl(text)}\n*EXT* : MP3\n*RESOLUTION* : ${args[1] || '360p'}\n\n*RESPETA WEBON*`
        ...
        ZimBotInc.sendMessage(m.chat, {
          video: { url: media.dl_link }, jpegThumbnail: buf, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `*Downloading From ${text}*`, quoted: m, contextInfo: {
            externalAdReply: {
              title: "BAUTISTA",
              body: "DRIPS",
              showAdAttribution: true,
...
*${botname}*`
        reply(`${result4}`)
        ZimBotInc.sendMessage(m.chat, {
          document: { url: baby1[0].link }, fileName: baby1[0].nama, mimetype: baby1[0].mime, quoted: mudratunha, contextInfo: {
            externalAdReply: {
              title: "BAUTISTA",
      ...
      case 'fbdl': case 'fb': case 'facebook': case 'fbvideo': {
        ...
        bocil.facebookdlv2(`${text}`).then(async (data) => {
          ...
          for (let i of data.result) {
            ZimBotInc.sendMessage(m.chat, {
              video: { url: i.url }, jpegThumbnail: buf, mimetype: 'video/mp4', caption: `* Quality :* ${i.quality}`, quoted: m, contextInfo: {
                externalAdReply: {
                  title: "BAUTISTA",
                  body: "SUBSCRIBE 240699",
                  showAdAttribution: true,
     ...
     *TIKTOK DL*\n\n*AUTHOR* : DRIPS\n*NICKNAME* : ${video.author.nickname}\n*CAPTION* : ${video.description}\n*QUALITY* : nowatermark\n*COMMENTS* : ${memek}\n*CREATE* ${hadir} Ago\n*LIKES* : ${hadi}\n*DISLIKE* : ${hadie}\n*SOURCE* : ${text}\n\n\n*RESPETA WEBON*`
      ...
      case 'warmsunset': {
        ...
        ZimBotInc.sendMessage(m.chat, {
          image: buf, jpegThumbnail: buf, caption: `PhotoFilter ${command}`, quoted: m, contextInfo: {
            externalAdReply: {
              title: "BAUTISTA",
              body: "SUBSCRIBE 240699",
              showAdAttribution: true,
      ...
      case 'summerysand': {
        ...
        ZimBotInc.sendMessage(m.chat, {
          image: anu, caption: `*EPHOTO ${command}*`, quoted: m, contextInfo: {
            externalAdReply: {
              title: "BAUTISTA",
              body: "SUBSCRIBE 240699",
              showAdAttribution: true,
...
View list of message with ${prefix}listmsg`)
      ...
      case 'mulai': case 'start': {
        ...
        if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
          ...
          await ZimBotInc.sendButtonText(m.chat, buttons, `_You Are Still In Anonymous Session, RESPETA WEBON To Terminate Your Anonymous Session_`, ZimBotInc.user.name, m)
          throw false
        }
...
`
        ...
        huso = await getBuffer(picak + 'RESPETA WEBON')
      ...
      case 'bug': case 'report': {
        ...
        ZimBotInc.sendMessage(`27634090203@s.whatsapp.net`, {
          text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}`
        })
        reply(`*Successfully reported to the owner\n\nPlease make sure the bug is valid, if you play with this, use this feature again and again for no reason, you will be banned for using240699*`)
      }
        break
      case 'listmenu':
        let sections = []
        ...
        for (let x of listmenu) {
          const list = {
            title: 'MENU NUMBER ' + nombor++,                                                                             //by drips
            rows: [
              {
                title: `${listmenuu[startnum++]}`,
...
%readmore`
        ...
        if (setbot.templateImage) {
          ...
          const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url: `https://github.com/juanbhmx` } }, { urlButton: { displayText: `GITHUB`, url: `https://github.com/juanbhmx` } },
          {
            quickReplyButton: {
              displayText: 'SPEED',
              id: 'ping'
